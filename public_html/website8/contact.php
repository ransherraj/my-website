...
-->
  ...
  <!-- header ends -->
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="color: black; background-image: url('images/slide-1.jpg');">
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div style="text-align: center;">
          <h1 class="section-title section-header text-center p-t-20" >Contact Us</h1>
          <br>
          <br>
          <p class="text-center">We are ready to hear from you. Write us if you feel so. </p>
          <br><br>
        </div>
        ...
        <div>
          <!-- <iframe style="border:0; width: 100%; height: 270px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.433213460943!2d-74.0062269!3d40.7101282!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xb89d1fe6bc499443!2sDowntown+Conference+Center!5e0!3m2!1smk!2sbg!4v1539943755621" frameborder="0" allowfullscreen></iframe> -->
            ...
            src="https://www.google.com/maps/embed/v1/directions?origin=place_id:ChIJXforGUgujjkR3Er0Rw1SOd8&destination=place_id:EklSYXRoeWF0cmEgS2FtYWNoaGEgUmQsIEd1cnViYWdoLCBCaGVsdXB1ciwgVmFyYW5hc2ksIFV0dGFyIFByYWRlc2gsIEluZGlhIi4qLAoUChIJN8K97v8xjjkRLFwQIhInel0SFAoSCZcW3Z__MY45EeDjJWEYxV0K&key=..."></iframe>  -->

            <img class="rounded mx-auto d-block" src="images/map.png" alt="">
        </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Garbage Manager Office,<br> Rathyatra, Kamachha Rd, Gurubagh, bhelupur,<br> varanasi-221005</p>
              </div>

              <div class="email">
                <i class="fa fa-envelope"></i>
                <h4>Email:</h4>
                <p>garbagemanager@info.in</p>
              </div>
  ...
  <script type="text/javascript">
    $(function() {
      $("#submit").click(function() {
          ...
          $(div).addClass("inner").html("Message sent sucessfully");
          $("#my-3").append(div);
        });
    });
</script>
